...
<style>
  ...
  .container { max-width: 720px; margin: auto; background: white; padding: 2rem; border-radius: 8px; box-shadow: 0 0 12px rgba(0,0,0,0.1); }
  h1 { margin-bottom: 1.5rem; font-weight: 700; }
...
<body>
  <div class="container" role="main">
    ...
    <input type="number" id="inputValue" class="form-control mb-3" placeholder="Enter numeric value (সংখ্যা লিখুন)" min="0" step="any" />
...
<script>
  ...
  const units = {
    paki: 47520,             // 1 Paki = 1 Bigha = 33 Decimal => 33*1440=47520 sqft approx
    bigha: 47520,
    decimal: 1440,           // 1 Decimal ~1440 sqft
    shotangsho: 435.6,       // 1 Shotangsho = 435.6 sqft
    kattah: 720,             // 1 Katha (Kattah) = 720 sqft approx
    ojutangsho: 4.356,       // 1 Ojutangsho = Shotangsho/100 = 4.356 sqft approx
    ...
    bargo_hat: 5.04,         // 1 Bargo Hat approx 5.04 sqft
